      ...
      <View>
        ...
        {!finish ? (
          <View style={styles.buttonsContainer}>
            <TouchableOpacity onPress={() => this.skipWizard()} style={styles.skipButton}>
              <Text style={styles.skipText}>Skip</Text>
            </TouchableOpacity>

            <TouchableOpacity onPress={() => this._carousel.snapToNext()} style={styles.nextButton}>
              <Text style={styles.nextText}>Next</Text>
            </TouchableOpacity>
          </View>
        ) : (
          <View style={styles.buttonsContainer}>
            <TouchableOpacity onPress={() => this.skipWizard()} style={styles.finishButton}>
